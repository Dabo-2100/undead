...
export interface ApiProductCatProductCat extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cat_name: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    product_cat: Schema.Attribute.Relation<
      'manyToOne',
      'api::product-cat.product-cat'
    >;
...
export interface ApiSliderOneSliderOne extends Struct.CollectionTypeSchema {
  collectionName: 'slider_ones';
  info: {
    displayName: 'Slider One';
    pluralName: 'slider-ones';
    singularName: 'slider-one';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::slider-one.slider-one'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    slide_img: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    slide_name: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::slider-one.slider-one': ApiSliderOneSliderOne;
